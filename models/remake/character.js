...
class Character {
  ...
  initial ({ characters }) {
    ...
    const uniqueWaTaShi = getItem(this.#system.user_id, 'uniqueWaTaShi')
    if (uniqueWaTaShi != null || uniqueWaTaShi != 'undefined') { this.#uniqueWaTaShi = JSON.parse(uniqueWaTaShi) }
    return this.count
  }
